...
def testGenerator_many(test_path, num_image=30, target_size=(256, 256), flag_multi_class=False, as_gray=True):
...
def testGenerator_1(test_path, target_size=(256, 256), flag_multi_class=False, as_gray=True):
